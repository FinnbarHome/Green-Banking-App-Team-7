...
describe("GET /api/companies/:accountNumber", () => {
  beforeEach(async () => {
    ...
    const existingCompany = await mongoose.connection
      .collection("Companies")
      .findOne({ "Account Number": 1 });
    ...
    if (!existingCompany) {
      ...
      const company = {
        ...
        "Account Number": 1,
        Summary:
          "RedFuel Services focuses on retail, specializing in affordable groceries. They invest heavily in sustainable farming but have higher carbon emissions from transportation.",
        Balance: 10000,
        XP: 0,
        Streak: 0,
      };
